...
alter table LineItems add constraint c1 foreign key(OrderId) references Orders (OrderId);
alter table LineItems add constraint c2 foreign key(ProductId ) references Products (Id);
alter table Orders add constraint c3 foreign key(AccountId) references Accounts (Id);
